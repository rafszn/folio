...
export const EXPERIENCES = [
  {
    ...
    stack:['React.js', 'Node.js', 'Express.js', 'OpenAI API']
  },  
...
export const PROJECTS = [

  {
    ...
    description:'This is a React application that allow users convert speech to text and upload audio files in various formats (e.g., mp3, wav) for transcription',
    stack: ['React js', 'Node js', 'Express js', 'OpenAI'],
  ...
  {
    title:'Iris AI',
    description:'This web app is designed to detect various eye defects such as glaucoma, cataract, myopia, hyperopia, and more. It utilizes some custom functions paired with alist of questions provided for the user to analyze eye symptoms and provide insights into potential eye health issues.',
    stack: ['React js', 'CSS'],
...

  {
    ...
    description:'A wordpress application that provides solutions to common business and living challenges in environmentally efficient ways.',
    stack: ['Wordpress', 'CSS'],
...
const DEEPFAKE = {
    ...
    description:'A deepfake detection app designed to identify and flag digital images, that have been manipulated or altered using deep learning techniques.',
